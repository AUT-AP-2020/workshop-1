 ...
 * European-style 24 hour clock. The clock shows hours and minutes and seconds. The range of
 * the clock is 00:00:00 (midnight) to 23:59:59 (one second before midnight).
 * 
 ...
 * 
 * @author Michael Kolling and David J. Barnes (Modified by Mohammad Safari)
 * @version 2020.03.23
 */
public class ClockDisplay {
    ...
    /**
     * This method should get called once every second - it makes the clock display
     * go one second forward.
     */
    public void timeTick_S() {
        seconds.increment();
